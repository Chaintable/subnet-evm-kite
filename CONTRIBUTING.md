...
a general-purpose fork of ava-labs/subnet-evm.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v0.8.0-ct.8`); a GitHub Release publishes the versioned images
...
terms as this repository — see the [LICENSE](./LICENSE), [COPYING](./COPYING) and
