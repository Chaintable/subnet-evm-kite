...
// Vendored from github.com/ava-labs/avalanchego@v1.14.0/vms/evm/metrics/prometheus
// with one change: GaugeInfo metrics are exported as info-style gauges instead
// of being skipped, so pipeline_node_info{chain_id, role} reaches Prometheus.
// The skip upstream is an unfinished TODO (coreth carried "TODO(qdm12) handle
// this somehow maybe with dto.MetricType_UNTYPED"). Drop this copy and switch
// back to the upstream import once the fix lands upstream.
